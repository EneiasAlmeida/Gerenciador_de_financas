...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primary: Color(4284700304),
      surfaceTint: Color(4284700304),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      inversePrimary: Color(4284700304),
      primaryFixed: Color(4293385983),
      onPrimaryFixed: Color(4280160328),
      primaryFixedDim: Color(4291673599),
      onPrimaryFixedVariant: Color(4283055734),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(4291937023),
      onPrimaryContainer: Color(4278190080),
      ...
      primaryFixedDim: Color(4291937023),
