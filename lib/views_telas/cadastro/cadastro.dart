...
class Cadastro extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: ehEdicao
          ? const Text('Edição de Registro')
          : const Text('Cadastro de Registro'),
        centerTitle: true,
      ),
      body: Padding(
            ...
            child: Column(
              ...
              children: [
                CampoTextoPersonalizado(
                  //aqui comeca ser executado o construtor de Campo Texto Personalizado
                  ...
                  onPressed: () async {
                    if (_formKey.currentState!.validate()) {
                      Registro registro = Registro(
                          //vai criar um objeto com os valores preenchidos
                          id: ehEdicao ? registroExistente.id : null,
                          nome: _nomeController.text,
                          // o método parse esta transformando a string num double
                      ...
                      if (ehEdicao) {
                        // Edição
                        // se for edição vai atualizar o registro no banco
                        registro.id = await repository.update(registro.toMap()); 
